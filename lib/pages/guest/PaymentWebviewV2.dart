...
class PaymentWebviewV2 extends StatefulWidget {
  var url;
  var title;

  PaymentWebviewV2({required this.url, required this.title, Key? key})
      : super(key: key);

  @override
  State<PaymentWebviewV2> createState() => _PaymentWebviewV2State(
        url,
        title,
      );
}

class _PaymentWebviewV2State extends State<PaymentWebviewV2> {
  ...
  _PaymentWebviewV2State(this.url, this.title);
